...
public class IndexTests
{
    ...
    public async Task Should_get_list_instructor_with_details()
    {
        ...
        var instructor1Id = await _fixture.SendAsync(
        ...
        var instructor2Id = await _fixture.SendAsync(
            new CreateEdit.Command
            {
        ...
        var result = await _fixture.SendAsync(
            new Index.Query { Id = instructor1Id, CourseId = english101.Id }
        );
